...
public class Modelbazooka<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bazooka"), "main");
	...
	public Modelbazooka(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r1 = LeftArm.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -50.0F, -24.0F, 4.0F, 48.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 22.0F, 0.0F, -1.3526F, 3.1416F, 0.0F));

		PartDefinition LeftArm_r2 = LeftArm.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, 2.0F, -24.0F, 4.0F, 48.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm2 = partdefinition
