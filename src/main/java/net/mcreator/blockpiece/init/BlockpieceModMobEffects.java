...
import net.mcreator.blockpiece.potion.TaktActiveMobEffect;
import net.mcreator.blockpiece.potion.RaceCooldownMobEffect;
...
public class BlockpieceModMobEffects {
	...
	public static final RegistryObject<MobEffect> TAKT_ACTIVE = REGISTRY.register("takt_active", () -> new TaktActiveMobEffect());
	public static final RegistryObject<MobEffect> RACE_COOLDOWN = REGISTRY.register("race_cooldown", () -> new RaceCooldownMobEffect());
}
