...
public class StartGuiButtonMessage {
	...
	public StartGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StartGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StartGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
