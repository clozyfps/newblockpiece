...
import net.mcreator.blockpiece.procedures.SwitchMovesetProcedureProcedure;
...
public class SwitchMovesetMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SwitchMovesetProcedureProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		BlockpieceMod.addNetworkMessage(SwitchMovesetMessage.class, SwitchMovesetMessage::buffer, SwitchMovesetMessage::new, SwitchMovesetMessage::handler);
	}
}
